...
<div class="<?php echo PREFIX;?>-panel <?php echo PREFIX;?>-panel--active">
   ...
   <div class="options_group">
      ...
      <p class="form-field">
         <label for="<?php echo Util::prefix('use_local_ean');?>"><?php _e('Manage EAN?', 'integration-marktplaats-for-woocommerce');?></label>
         <input type="hidden" name="<?php echo Util::prefix('fields[simple][use_local_ean]');?>" value="no" />
         <input
            type="checkbox"
            id="<?php echo Util::prefix('use_local_ean');?>"
            name="<?php echo Util::prefix('fields[simple][use_local_ean]');?>"
            data-<?php echo PREFIX;?>-has-extra-field="<?php echo Util::prefix('use_local_ean');?>"
            <?php checked( 'yes', $meta->get('use_local_ean') );?>
            value="yes"
         />
      ...
      <p class="form-field" data-<?php echo PREFIX;?>-extra-field-<?php echo Util::prefix('use_local_ean');?>="yes" style="<?php echo Util::css_display( 'yes', $meta->get('use_local_ean') );?>">
         <label for="<?php echo Util::prefix('ean');?>">
            <?php _e('EAN code', 'integration-marktplaats-for-woocommerce');?>
         </label>
         <input
            type="text"
            id="<?php echo Util::prefix('ean');?>"
            name="<?php echo Util::prefix('fields[simple][ean]');?>"
