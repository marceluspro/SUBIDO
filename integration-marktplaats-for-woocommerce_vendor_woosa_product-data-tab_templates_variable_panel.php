...
<div class="nav-tab-wrapper <?php echo PREFIX;?>-tab-wrapper" data-<?php echo PREFIX;?>-tablist>
   <div class="nav-tab nav-tab-active"><?php _e('Variations', 'integration-marktplaats-for-woocommerce');?></div>
</div>
...
<div class="<?php echo PREFIX;?>-panel-wrapper" data-<?php echo PREFIX;?>-tabpanel>
   ...
   <div class="<?php echo PREFIX;?>-panel <?php echo PREFIX;?>-panel--active">
      <?php foreach ($variations as $var_id):
         ...
         <div class="<?php echo PREFIX;?>-variation__content">
            ...
            <div class="<?php echo PREFIX;?>-panel-wrapper" data-<?php echo PREFIX;?>-tabpanel>
               ...
               echo Util::get_template('general-tab.php', [
                  'product' => $product,
                  'meta' => $meta,
               ], dirname(dirname(dirname(dirname(__FILE__)))), untrailingslashit(basename(dirname(dirname(dirname(__FILE__))))) . '/templates/variable/tabs');
